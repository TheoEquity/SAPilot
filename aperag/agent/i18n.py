...
ERROR_MESSAGES = {
    "en-US": {
        ...
        "processing_error": "Unable to process your request. Please try again. (无法处理您的请求，请重试)",
    ...
    "zh-CN": {
        ...
        "processing_error": "无法处理您的请求，请重试 (Unable to process your request. Please try again.)",
